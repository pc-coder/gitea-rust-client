...
pub trait RepositoryApi {
    ...
    fn repo_get_all_commits(&self, owner: &str, repo: &str, sha: &str, path: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Commit>, Error = Error<serde_json::Value>>>;
    ...
    fn repo_get_note(&self, owner: &str, repo: &str, sha: &str) -> Box<Future<Item = ::models::Note, Error = Error<serde_json::Value>>>;
    ...
    fn repo_get_pull_request_commits(&self, owner: &str, repo: &str, index: i64, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Commit>, Error = Error<serde_json::Value>>>;
