...
pub trait IssueApi {
    ...
    fn issue_check_subscription(&self, owner: &str, repo: &str, index: i64) -> Box<Future<Item = ::models::WatchInfo, Error = Error<serde_json::Value>>>;
    ...
    fn issue_delete(&self, owner: &str, repo: &str, index: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    ...
    fn issue_delete_milestone(&self, owner: &str, repo: &str, id: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    ...
    fn issue_edit_milestone(&self, owner: &str, repo: &str, id: &str, body: ::models::EditMilestoneOption) -> Box<Future<Item = ::models::Milestone, Error = Error<serde_json::Value>>>;
    fn issue_get_comment(&self, owner: &str, repo: &str, id: i64) -> Box<Future<Item = ::models::Comment, Error = Error<serde_json::Value>>>;
    ...
    fn issue_get_comments(&self, owner: &str, repo: &str, index: i64, since: String, before: String) -> Box<Future<Item = Vec<::models::Comment>, Error = Error<serde_json::Value>>>;
    fn issue_get_comments_and_timeline(&self, owner: &str, repo: &str, index: i64, since: String, page: i32, limit: i32, before: String) -> Box<Future<Item = Vec<::models::TimelineComment>, Error = Error<serde_json::Value>>>;
    fn issue_get_issue(&self, owner: &str, repo: &str, index: i64) -> Box<Future<Item = ::models::Issue, Error = Error<serde_json::Value>>>;
    fn issue_get_issue_reactions(&self, owner: &str, repo: &str, index: i64, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Reaction>, Error = Error<serde_json::Value>>>;
    ...
    fn issue_get_milestone(&self, owner: &str, repo: &str, id: &str) -> Box<Future<Item = ::models::Milestone, Error = Error<serde_json::Value>>>;
    fn issue_get_milestones_list(&self, owner: &str, repo: &str, state: &str, name: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Milestone>, Error = Error<serde_json::Value>>>;
    fn issue_get_repo_comments(&self, owner: &str, repo: &str, since: String, before: String, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Comment>, Error = Error<serde_json::Value>>>;
    fn issue_list_issues(&self, owner: &str, repo: &str, state: &str, labels: &str, q: &str, _type: &str, milestones: &str, since: String, before: String, created_by: &str, assigned_by: &str, mentioned_by: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Issue>, Error = Error<serde_json::Value>>>;
    fn issue_list_labels(&self, owner: &str, repo: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Label>, Error = Error<serde_json::Value>>>;
    ...
    fn issue_search_issues(&self, state: &str, labels: &str, milestones: &str, q: &str, priority_repo_id: i64, _type: &str, since: String, before: String, assigned: bool, created: bool, mentioned: bool, review_requested: bool, owner: &str, team: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Issue>, Error = Error<serde_json::Value>>>;
    ...
    fn issue_subscriptions(&self, owner: &str, repo: &str, index: i64, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::User>, Error = Error<serde_json::Value>>>;
    fn issue_tracked_times(&self, owner: &str, repo: &str, index: i64, user: &str, since: String, before: String, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::TrackedTime>, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>IssueApi for IssueApiClient<C> {
    ...
    fn issue_check_subscription(&self, owner: &str, repo: &str, index: i64) -> Box<Future<Item = ::models::WatchInfo, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/{index}/subscriptions/check?{}", configuration.base_path, query_string, owner=owner, repo=repo, index=index);
    ...
    fn issue_get_comments_and_timeline(&self, owner: &str, repo: &str, index: i64, since: String, page: i32, limit: i32, before: String) -> Box<Future<Item = Vec<::models::TimelineComment>, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/{index}/timeline?{}", configuration.base_path, query_string, owner=owner, repo=repo, index=index);
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<Vec<::models::TimelineComment>, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
    ...
    fn issue_list_issues(&self, owner: &str, repo: &str, state: &str, labels: &str, q: &str, _type: &str, milestones: &str, since: String, before: String, created_by: &str, assigned_by: &str, mentioned_by: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Issue>, Error = Error<serde_json::Value>>> {
        ...
        let query_string = {
            ...
            query.append_pair("milestones", &milestones.to_string());
            query.append_pair("since", &since.to_string());
            query.append_pair("before", &before.to_string());
            query.append_pair("created_by", &created_by.to_string());
            query.append_pair("assigned_by", &assigned_by.to_string());
            query.append_pair("mentioned_by", &mentioned_by.to_string());
            query.append_pair("page", &page.to_string());
            query.append_pair("limit", &limit.to_string());
            for (key, val) in &auth_query {
                query.append_pair(key, val);
    ...
    fn issue_search_issues(&self, state: &str, labels: &str, milestones: &str, q: &str, priority_repo_id: i64, _type: &str, since: String, before: String, assigned: bool, created: bool, mentioned: bool, review_requested: bool, owner: &str, team: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Issue>, Error = Error<serde_json::Value>>> {
        ...
        let query_string = {
            ...
            query.append_pair("since", &since.to_string());
            query.append_pair("before", &before.to_string());
            query.append_pair("assigned", &assigned.to_string());
            query.append_pair("created", &created.to_string());
            query.append_pair("mentioned", &mentioned.to_string());
            query.append_pair("review_requested", &review_requested.to_string());
