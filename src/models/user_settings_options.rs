...
impl UserSettingsOptions {
  ...
  pub fn with_description(mut self, description: String) -> UserSettingsOptions {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_diff_view_style(mut self, diff_view_style: String) -> UserSettingsOptions {
    self.diff_view_style = Some(diff_view_style);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> UserSettingsOptions {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_hide_activity(mut self, hide_activity: bool) -> UserSettingsOptions {
    self.hide_activity = Some(hide_activity);
    self
  }
  ...
  pub fn with_hide_email(mut self, hide_email: bool) -> UserSettingsOptions {
    self.hide_email = Some(hide_email);
    self
  }
  ...
  pub fn with_language(mut self, language: String) -> UserSettingsOptions {
    self.language = Some(language);
    self
  }
  ...
  pub fn with_location(mut self, location: String) -> UserSettingsOptions {
    self.location = Some(location);
    self
  }
  ...
  pub fn with_theme(mut self, theme: String) -> UserSettingsOptions {
    self.theme = Some(theme);
    self
  }
  ...
  pub fn with_website(mut self, website: String) -> UserSettingsOptions {
    self.website = Some(website);
    self
  }
