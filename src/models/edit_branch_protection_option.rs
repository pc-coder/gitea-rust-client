...
impl EditBranchProtectionOption {
  ...
  pub fn with_approvals_whitelist_teams(mut self, approvals_whitelist_teams: Vec<String>) -> EditBranchProtectionOption {
    self.approvals_whitelist_teams = Some(approvals_whitelist_teams);
    self
  }
  ...
  pub fn with_approvals_whitelist_username(mut self, approvals_whitelist_username: Vec<String>) -> EditBranchProtectionOption {
    self.approvals_whitelist_username = Some(approvals_whitelist_username);
    self
  }
  ...
  pub fn with_block_on_official_review_requests(mut self, block_on_official_review_requests: bool) -> EditBranchProtectionOption {
    self.block_on_official_review_requests = Some(block_on_official_review_requests);
    self
  }
  ...
  pub fn with_block_on_outdated_branch(mut self, block_on_outdated_branch: bool) -> EditBranchProtectionOption {
    self.block_on_outdated_branch = Some(block_on_outdated_branch);
    self
  }
  ...
  pub fn with_block_on_rejected_reviews(mut self, block_on_rejected_reviews: bool) -> EditBranchProtectionOption {
    self.block_on_rejected_reviews = Some(block_on_rejected_reviews);
    self
  }
  ...
  pub fn with_dismiss_stale_approvals(mut self, dismiss_stale_approvals: bool) -> EditBranchProtectionOption {
    self.dismiss_stale_approvals = Some(dismiss_stale_approvals);
    self
  }
  ...
  pub fn with_enable_approvals_whitelist(mut self, enable_approvals_whitelist: bool) -> EditBranchProtectionOption {
    self.enable_approvals_whitelist = Some(enable_approvals_whitelist);
    self
  }
  ...
  pub fn with_enable_merge_whitelist(mut self, enable_merge_whitelist: bool) -> EditBranchProtectionOption {
    self.enable_merge_whitelist = Some(enable_merge_whitelist);
    self
  }
  ...
  pub fn with_enable_push(mut self, enable_push: bool) -> EditBranchProtectionOption {
    self.enable_push = Some(enable_push);
    self
  }
  ...
  pub fn with_enable_push_whitelist(mut self, enable_push_whitelist: bool) -> EditBranchProtectionOption {
    self.enable_push_whitelist = Some(enable_push_whitelist);
    self
  }
  ...
  pub fn with_enable_status_check(mut self, enable_status_check: bool) -> EditBranchProtectionOption {
    self.enable_status_check = Some(enable_status_check);
    self
  }
  ...
  pub fn with_merge_whitelist_teams(mut self, merge_whitelist_teams: Vec<String>) -> EditBranchProtectionOption {
    self.merge_whitelist_teams = Some(merge_whitelist_teams);
    self
  }
  ...
  pub fn with_merge_whitelist_usernames(mut self, merge_whitelist_usernames: Vec<String>) -> EditBranchProtectionOption {
    self.merge_whitelist_usernames = Some(merge_whitelist_usernames);
    self
  }
  ...
  pub fn with_protected_file_patterns(mut self, protected_file_patterns: String) -> EditBranchProtectionOption {
    self.protected_file_patterns = Some(protected_file_patterns);
    self
  }
  ...
  pub fn with_push_whitelist_deploy_keys(mut self, push_whitelist_deploy_keys: bool) -> EditBranchProtectionOption {
    self.push_whitelist_deploy_keys = Some(push_whitelist_deploy_keys);
    self
  }
  ...
  pub fn with_push_whitelist_teams(mut self, push_whitelist_teams: Vec<String>) -> EditBranchProtectionOption {
    self.push_whitelist_teams = Some(push_whitelist_teams);
    self
  }
  ...
  pub fn with_push_whitelist_usernames(mut self, push_whitelist_usernames: Vec<String>) -> EditBranchProtectionOption {
    self.push_whitelist_usernames = Some(push_whitelist_usernames);
    self
  }
  ...
  pub fn with_require_signed_commits(mut self, require_signed_commits: bool) -> EditBranchProtectionOption {
    self.require_signed_commits = Some(require_signed_commits);
    self
  }
  ...
  pub fn with_required_approvals(mut self, required_approvals: i64) -> EditBranchProtectionOption {
    self.required_approvals = Some(required_approvals);
    self
  }
  ...
  pub fn with_status_check_contexts(mut self, status_check_contexts: Vec<String>) -> EditBranchProtectionOption {
    self.status_check_contexts = Some(status_check_contexts);
    self
  }
  ...
  pub fn with_unprotected_file_patterns(mut self, unprotected_file_patterns: String) -> EditBranchProtectionOption {
    self.unprotected_file_patterns = Some(unprotected_file_patterns);
    self
  }
