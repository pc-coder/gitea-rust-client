...
impl CreateOrgOption {
  ...
  pub fn with_description(mut self, description: String) -> CreateOrgOption {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> CreateOrgOption {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_location(mut self, location: String) -> CreateOrgOption {
    self.location = Some(location);
    self
  }
  ...
  pub fn with_repo_admin_change_team_access(mut self, repo_admin_change_team_access: bool) -> CreateOrgOption {
    self.repo_admin_change_team_access = Some(repo_admin_change_team_access);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> CreateOrgOption {
    self.username = username;
    self
  }
  ...
  pub fn with_visibility(mut self, visibility: String) -> CreateOrgOption {
    self.visibility = Some(visibility);
    self
  }
  ...
  pub fn with_website(mut self, website: String) -> CreateOrgOption {
    self.website = Some(website);
    self
  }
