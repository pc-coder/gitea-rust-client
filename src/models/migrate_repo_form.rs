...
pub struct MigrateRepoForm {
  ...
  service: Option<::models::GitServiceType>,
  #[serde(rename = "uid")]
  uid: i64,
  #[serde(rename = "wiki")]
  wiki: Option<bool>
...
impl MigrateRepoForm {
  ...
  pub fn with_auth_token(mut self, auth_token: String) -> MigrateRepoForm {
    self.auth_token = Some(auth_token);
    self
  }
  ...
  pub fn with_lfs(mut self, lfs: bool) -> MigrateRepoForm {
    self.lfs = Some(lfs);
    self
  }
  ...
  pub fn with_lfs_endpoint(mut self, lfs_endpoint: String) -> MigrateRepoForm {
    self.lfs_endpoint = Some(lfs_endpoint);
    self
  }
  ...
  pub fn with_mirror_interval(mut self, mirror_interval: String) -> MigrateRepoForm {
    self.mirror_interval = Some(mirror_interval);
    self
  }
  ...
  pub fn set_service(&mut self, service: ::models::GitServiceType) {
    self.service = Some(service);
  }

  pub fn with_service(mut self, service: ::models::GitServiceType) -> MigrateRepoForm {
    self.service = Some(service);
    self
  }

  pub fn service(&self) -> Option<&::models::GitServiceType> {
    self.service.as_ref()
  }
